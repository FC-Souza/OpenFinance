...
namespace WebAPI.OpenFinance.Migrations
{
    ...
    [Migration("20250327000750_AddingBenchmarkIndexTable")]
    partial class AddingBenchmarkIndexTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.OpenFinance.Models.ProfitReportModel", b =>
                {
                    ...
                    b.Property<decimal>("TotalAmountInvested")
                        .HasColumnType("numeric")
                        .HasColumnName("total_amount_invested");

                    b.Property<decimal>("TotalProfit")
                        .HasColumnType("numeric")
                        .HasColumnName("total_profit_loss");

                    b.Property<decimal>("TotalProfitPercentage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("total_profit_loss_percentage");
            ...
            modelBuilder.Entity("WebAPI.OpenFinance.Models.TransactionDirectionModel", b =>
                {
                    b.Property<int>("TransactionDirectionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("transaction_direction_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("TransactionDirectionID"));

                    b.Property<string>("TransactionDirectionName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("transaction_direction_name");

                    b.HasKey("TransactionDirectionID");

                    b.ToTable("transaction_direction");
                });
            ...
            modelBuilder.Entity("WebAPI.OpenFinance.Models.TransactionTypeModel", b =>
                {
                    b.Property<int>("TransactionTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("WebAPI.OpenFinance.Models.TransactionModel", b =>
                {
                    ...
                    b.HasOne("WebAPI.OpenFinance.Models.TransactionTypeModel", "TransactionType")
                        .WithMany()
